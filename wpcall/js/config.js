...
JSCommSettings = {
  ...
  stun_servers: [],
  turn_servers: [
    { server:"turn:stun-test.sip5060.net:3478", username:"test", password:"notasecret" }
  ],
  ...
  user: {
    display_name: 'mesut',
    uri: 'sip:mesut1@ws.sip5060.net',
    sip_auth_user: 'mesut1@ws.sip5060.net',
    sip_auth_password: 'cGetaAgdV',
